  ...
  const createCustomCharacter = async () => {
    ...
    try {
      ...
      const customCharacter = {
        ...
        looks: `${character.hairColor}_hair, ${character.hairStyle}, ${character.eyeColor}_eyes, ${character.bodyType}, ${character.breastSize}_breasts, ${character.age}_years_old, ${character.ethnicity}, ${character.personality}, ${character.occupation}`,
          ...
          {localGeneratedImage && !isGeneratingImage && !isCreatingCharacter && (
            <>
              <button
                ...
                className="w-full px-6 py-3 rounded-lg bg-gradient-to-r from-[#4c5eeb] to-[#6b7bee] text-white 
                  transition-all border border-[#7b89ef] hover:shadow-lg hover:scale-[1.02] active:scale-100
              ...
              <button
                ...
                className={`w-full px-6 py-3 rounded-lg text-white transition-all border border-[#7b89ef] text-base
                  ${isGeneratingImage || isCreatingCharacter
                    ? 'bg-[#4c5eeb]/50 cursor-not-allowed'
                    : 'bg-[#4c5eeb] hover:bg-[#3b4eda] hover:shadow-lg hover:scale-[1.02] active:scale-100'}`}
              >
                {isGeneratingImage ? (
                  <div className="flex items-center justify-center gap-2">
